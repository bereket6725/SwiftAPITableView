//
//  DummyJSONTableTableViewController.swift
//  FakeJSONProject
//
...
class DummyJSONTableTableViewController: UITableViewController {

    var urlString: String = "http://jsonplaceholder.typicode.com/photos"
    var bodyArray:[String] = []
    var detailImageStringToPass = String()

    struct image {
        let thumbNailImageLink: String
        var detailImageLink: String
        init (thumbNailImageLink: String, detailImageLink: String){
        
            self.thumbNailImageLink = thumbNailImageLink
            self.detailImageLink    = detailImageLink
        
        }
        
    }
    var linksArray: [image] = []
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        var urlString: image = self.linksArray[indexPath.row]
        urlString.detailImageLink = self.detailImageStringToPass
        ...
        do {
            if let convertedJsonIntoArr = try NSJSONSerialization.JSONObjectWithData(data, options: []) as? NSArray {
                ...
                for dict in convertedJsonIntoArr {
                    ...
                    let link = image(thumbNailImageLink: dict["thumbnailUrl"] as! String, detailImageLink: dict["url"] as! String)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
      ...
      //  cell.textLabel!.text = self.bodyArray[indexPath.row]
          cell.textLabel!.text = self.linksArray[indexPath.row].thumbNailImageLink
        return cell
    }
...
//       let navigationController = segue.destinationViewController as! DetailImageViewController
//       navigationController.detailLink = self.detailImageStringToPass
